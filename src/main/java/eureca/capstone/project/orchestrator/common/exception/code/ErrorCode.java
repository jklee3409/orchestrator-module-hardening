...
public enum ErrorCode {
    ...
    EVENT_COUPON_NOT_FOUND(40003, "EVENT_NOT_FOUND", "이벤트 쿠폰을 찾을 수 없습니다."),
    USER_EVENT_COUPON_ALREADY_EXISTS(40004, "USER_EVENT_COUPON_ALREADY_EXISTS", "이미 발급된 이벤트 쿠폰입니다."),
